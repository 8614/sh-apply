...
class Writer {
	 ...
	 * @return void
	 */
	public function useDailyFiles($path, $days = 0, $level = 'debug', $filePermission = null)
	{
		$level = $this->parseLevel($level);

		$this->monolog->pushHandler($handler = new RotatingFileHandler($path, $days, $level, true, $filePermission));
